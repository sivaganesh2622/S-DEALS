...
const Login = ({setToken}) => {
  ...
  return (
    ...
    <div className='min-h-screen flex items-center justify-center w-2000 bg-[url(C:\Users\hp\Desktop\Sdeals-full-stack\admin\src\assets\logod.png)] bg-no-repeat bg-cover bg-position-center '>
        <div className='bg-red-900 shadow-md rounded-lg px-8 py-6 max-w-md '>
